...
public class TaskIT {
    ...
    public static void setup() {
        clientFactory = LagomClientFactory.create("integration-test", TaskIT.class.getClassLoader());
        ...
        taskService = clientFactory.createDevClient(TaskService.class, URI.create(SERVICE_LOCATOR_URI));
    ...
    public void helloStream() throws Exception {
        ...
        Source<String, ?> response = await(taskService.stream().invoke(
